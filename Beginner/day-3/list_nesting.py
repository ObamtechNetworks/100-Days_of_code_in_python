...
# get the row and col from user input and convert thme to int
row = int(position[0])
col = int(position[1])
# print(col, row)

# next is to use these as indices for the map nested list and change value
# PLACE TO PUT TREASURE at cordinate col, row
map[col - 1][row - 1] = "X"
